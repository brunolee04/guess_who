...
export function Card(){
    ...
    const person = [1,random(0,2),random(1,10),random(0,13),random(1,3),random(1,4),0,random(0,4),random(0,5),random(1,4),random(0,2),random(0,3)];
    ...
    const headImg     = person[5]<1?'':<img src={`${urlImgPrefix}/1/${person[1]}/head/${person[5]}.fw.png`}/>;
